<!-- PAGE 964 | type=text | model=claude-opus-4-7 -->
...
Página de notas eruditas (cap. 47 das Notæ) ao fragmento de Nicolau de Damasco preservado por Eusébio/Josefo, sobre os reis de Damasco (Adad/Ben-hadad). Discute variantes textuais entre o original grego e a versão latina de Rufino, e contesta as afirmações de Justino (epítome de Trogo) sobre a sucessão dos reis sírios.
