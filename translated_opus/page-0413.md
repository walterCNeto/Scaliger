<!-- PAGE 413 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Cânon da Correção Pascal, por Nicéforo Gregoras, cujo método Argyrus expõe no texto precedente. Colunas laterais: ciclos áureos; colunas internas: ciclo solar grego pareado; última coluna: epactas. A = Aprilis, M = Martius.
**en:** Canon of the Paschal Emendation, by Nicephorus Gregoras, whose method Argyrus explains in the preceding section. Side columns: golden cycles; inner columns: paired Greek solar cycle; last column: epacts. A = April, M = March.
...
Página apresenta conclusão da citação de Isaac Argyrus sobre a imprecisão acumulada do ciclo decenovenal, seguida do Canon Paschalis Emendationis de Nicéforo Gregoras — tabela de 19 linhas correlacionando ciclos áureos latinos e gregos com datas pascais (A=Aprilis, M=Martius) e letras dominicais (numerais romanos I-VII), mais coluna final de epactas. Scaliger explica abaixo que o ciclo grego começa no ciclo XVIII dos latinos, ambos compartilhando a letra F.
