<!-- PAGE 826 | type=text | model=claude-opus-4-7 -->
...
Página inteiramente em grego; trata-se de citação/extrato bizantino (aparenta ser de Máximo o Confessor ou fonte cronológica similar, Computus Paschalis) incorporado por Scaliger. Discute as datas do nascimento de Cristo, do batismo, da paixão, e do anúncio a Zacarias, com referência a anos solares, lunares e de indicção. O fragmento 'ΧΡΟ=' no final é o início da próxima seção ('ΧΡΟΝΟΓΡΑΦΙΑ' ou similar). Nenhum evento astronômico observacional (eclipse, conjunção) é citado—apenas estrutura cronológica computística.
