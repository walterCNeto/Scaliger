<!-- PAGE 949 | type=text | model=claude-opus-4-7 -->
...
- Transcrição de termos gregos com acentos no scan parcialmente difíceis de ler; mantida grafia mais plausível.
- Forma 'cuiates' no verso de Plauto pode ser variante de 'cuiatis'; preservada como no original.
