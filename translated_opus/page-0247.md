<!-- PAGE 247 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Tábua do primeiro ciclo da grande período pascal: ciclo Dionisiano, ciclo vicioso, epactas do ano solar, escrúpulos diurnos, dias desde as Calendas de Janeiro, termos pascais do ciclo vicioso, ciclo solar.
**en:** Table of the first cycle of the great Paschal period: Dionysian cycle, faulty cycle, epacts of the solar year, daily scruples, days from the Kalends of January, Paschal terms of the faulty cycle, solar cycle.

| Cyclus Dionysianus | Cyclus vitiosus | Epactae anni Solaris | Scrupuli diurni | Dies a Kal. Ianuarii collecti | Termini Paschalis cycli vitiosi | Cyclus Solis |
|---|---|---|---|---|---|---|
| 4 | 1 | 11 | 5 | 92 | 14 | F E |
| 5 | 2 | 22 | 10 | 81 | 14 | D |
| 6 | 3 | 33 | 15 | 100 | 14 | C |
...
- Formas gregas ἀνασταίσιμον e ἀπλαίστως podem ser leituras do tipógrafo de ἀναστάσιμον e ἀπταίστως; preservamos a impressão e notamos o sentido.
- Na tabela, linha do cyclus vitiosus 12: a epacta foi lida como 133 (embora esperado seria 132 segundo progressão regular de +11); preservada conforme impresso.
- Na linha 19 (cyclus Dionysianus 3, vitiosus 19) a epacta lida é 210; progressão regular daria 209 ou similar.


### Notas do tradutor

Página expõe a tabela comparativa entre o ciclo pascal dionisiano e o 'ciclo vicioso' dos adversários criticados por Máximo o Monge. A discussão central são coincidências (συνέμπτωσις) e antecipações (προέμπτωσις) da data pascal em relação à Lua XIV. Referência chave: '532 anos' = período pascal completo (19 × 28).
