<!-- PAGE 523 | type=text | model=claude-opus-4-7 -->
...
- **solar_eclipse**: defectus ... qui convenit nocti, quae secuta est XXI Iunii Iuliani, anno periodi Iulianae 4546 _(data: noite anterior à véspera das Nonas de setembro romano (pridie Nonas Septembris); 21 de junho juliano; ano 4546 do período juliano; consulado de L. Emílio Paulo e C. Licínio Crasso, local: , fonte: )_
- **solstice**: epocha κέντρου χειμερινοῦ Athenis (época do centro/solstício de inverno em Atenas) _(data: 8 ou 9 de janeiro, local: Atenas, fonte: )_
- **solstice**: Etiam Sol novus est VIII Kal. Ianuarii die (o Sol é novo no 8º dia antes das Calendas de janeiro) _(data: VIII Kal. Ianuarii (25 de dezembro), local: , fonte: Servius)_
- **other**: Censorinus: aliis a novo Sole, id est, a bruma, aliis ab aestivo Solstitio, plerisque ab aequinoctio verno — diferentes pontos de início do ano (solstício de inverno, solstício de verão, equinócio da primavera) _(data: , local: , fonte: Censorinus)_
...
Página discute a discrepância entre calendário romano pré-juliano e juliano, a partir de um eclipse no consulado de L. Emílio Paulo e C. Licínio Crasso (provavelmente eclipse solar de 168 a.C., véspera da batalha de Pidna, relatado por Lívio). Citações de Censorino, Virgílio (Geórgicas I), Sérvio, Gélio, Estácio (Silvae IV.1) e Macróbio (Saturnália I.10).
