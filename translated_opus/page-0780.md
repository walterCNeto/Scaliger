<!-- PAGE 780 | type=text | model=claude-opus-4-7 -->
...
Página comentário sobre o calendário litúrgico etíope e sírio, contendo termos em grego, siríaco e ge'ez (etíope). Sem eventos astronômicos ou tabelas numéricas.
