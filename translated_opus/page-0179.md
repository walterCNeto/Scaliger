<!-- PAGE 179 | type=table | model=claude-opus-4-7 -->
...
**pt:** Tábua do Período dos Sírios de Alexandria — anos 1–76 do período, com ciclo lunar, caractere do ano, ciclo solar, data (setembro/agosto) e epacta. A coluna marginal à esquerda/direita marca ἐμβόλ(ιμος) = ano embolímico (intercalar) e ἰάφ(?) = possível marca secundária.
**en:** Table of the Period of the Syrians of Alexandria — years 1–76 of the period, with lunar cycle, year character, solar cycle, date (September/August) and epact. The marginal column at left/right marks ἐμβόλ(ιμος) = embolismic (intercalary) year and ἰάφ(?) = possible secondary mark.
...
Página 179 (numerada '96' no topo — provável erro tipográfico do impressor ou numeração alternativa). Página quase inteiramente ocupada pela Tábua do período dos Siro-Macedônios/Alexandrinos, com seis colunas: ano do período, ciclo lunar (áureo número 1–19), caractere do ano (1–7, provavelmente dia da semana ou concurrens), ciclo solar (letra dominical), data da neomênia de setembro, e epacta. Os anos marcados ἐμβόλιμος são os embolísmicos (intercalares, com 13 meses lunares). O texto explicativo continua na página seguinte com 'annorum...'.
