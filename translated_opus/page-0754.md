<!-- PAGE 754 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Tabela de epactas etíopes e dias de Mascaram/Tikmith Matque para os anos I–IX do ciclo
**en:** Table of Ethiopian epacts and days of Mascaram/Tikmith Matque for years I–IX of the cycle

| Anno | Epacta | Dies |
|------|--------|------|
| I | XI | XIX Mascaram Matque |
| II | XXII | VIII Tikmith Matque |
| III | III | XXV Mascaram Matque |
| IV | XIV | XVI Mascaram Matque |
| V | XXV | V Tikmith Matque |
| VI | VI | XXIV Mascaram Matque |
| VII | XVII | XIII Tikmith Matque |
| VIII | XXVIII | II Tikmith Matque |
| IX | IX | XXI Mascaram Matque |


### Flags de incerteza

- O texto em escrita etiópica (Ge'ez) na coluna direita e o texto aramaico/hebraico na coluna esquerda não foram transliterados nesta transcrição por limitação de leitura; apenas indicados como blocos.
- A tradução de 'quatuor aquabis' (quatro igualarás) é obscura — parece instrução de algoritmo computacional etíope.
- 'Nouenadena' aparentemente transliteração do termo etíope para 19 (cf. ge'ez para número dezenove).


### Notas do tradutor

Página bilíngue/trilíngue que apresenta em coluna esquerda texto semítico (hebraico/aramaico) com pontos vocálicos e em coluna direita texto em etíope clássico (Ge'ez), ambos tratando do cômputo eclesiástico etíope. Scaliger traduz ao latim a seguir, expondo o algoritmo de cálculo do ano pelo módulo 19 (ciclo lunar) com epactas etíopes e datas em Mascaram (primeiro mês) e Tikmith (segundo mês) do calendário etíope. A página termina com reclamo 'In x' indicando continuação (ano X) na página seguinte.
