<!-- PAGE 654 | type=text | model=claude-opus-4-7 -->
...
Página discute o duplo lavamento e a dupla ceia no rito pascal judaico, com paralelos entre o costume dos 'hemerobaptistas', o lava-pés greco-romano (ποδονιπτήρ), e as 'secundae mensae' dos gentios. Inclui citações de Plauto (Persa), Virgílio (sobre a uva de Rodes) e referência a Horácio e Sérvio. Não há eventos astronômicos nesta página.
