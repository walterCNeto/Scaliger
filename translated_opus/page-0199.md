<!-- PAGE 199 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Lista de nomes de meses (hebraicos/samaritanos) no topo da página, aparentemente chave de um diagrama na página anterior.
**en:** List of month names (Hebrew/Samaritan) at the top of the page, apparently a key to a diagram on the previous page.
...
- **other**: vt in illo anno 1584 Christi σκηνοπηγίαν serius celebrarunt, quam Iudaei, vno mense _(data: anno 1584 Christi, local: , fonte: Samaritani)_
- **other**: Tabella nouiluniorum subiecta, cum momentis suis; hora = 1800 vel 300 momenta, quia Iudaica momenta 1080 _(data: , local: , fonte: )_
...
Página discute a calendárica samaritana, a correspondência entre Sukkot (Tabernáculos) em Elul/Tisri, e introduz tabela de neomênias com hora dividida em 1800 ou 300 momentos (em vez dos 1080 judaicos) para facilitar divisões. A palavra final 'TABEL-' indica catchword para 'TABELLA' na próxima página.
