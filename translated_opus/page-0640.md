<!-- PAGE 640 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Índice dos sábados da Pentecostes (intervalo entre a Páscoa e Pentecostes): nome grego, data em Nisan/Ijar/Sivan, e correspondência em calendário romano-juliano (março, abril, maio).
**en:** Index of the sabbaths of Pentecost (interval between Passover and Pentecost): Greek name, date in Nisan/Iyar/Sivan, and equivalent in the Roman-Julian calendar (March, April, May).
...
Página sobre a 'terceira Páscoa' do ministério de Jesus, com discussão filológica do termo σάββατον δευτερόπρωτον (Lc 6,1) e uma tabela cronológica de sete sábados entre a Páscoa e Pentecostes de um ano específico, correlacionando calendário judaico (Nisan/Ijar/Sivan) e calendário juliano (março/abril/maio).
