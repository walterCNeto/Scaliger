<!-- PAGE 783 | type=text | model=claude-opus-4-7 -->
...
Página pertence ao comentário de Scaliger sobre o computus etiópico (cômputo das festas móveis na Igreja Etíope). Os numerais romanos minúsculos do original foram transcritos em maiúsculas por convenção editorial. A tradução preserva os nomes dos meses etíopes (Miazia=Miyazya, Iachathith=Yakatit, Magabith=Magabit, Ginboth=Genbot, Tir=Ṭǝrr) e dos festivais (Niniue=jejum de Nínive, Hosanna=Domingo de Ramos, Racbe=quarta-feira sinódica, Tessaracosta=Quadragésima).
