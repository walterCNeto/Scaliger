<!-- PAGE 149 | type=text | model=claude-opus-4-7 -->
...
- **other**: Neomeniae primae Tetraeteridos, & tertiae ineuntium incidunt in novilunia _(data: , local: , fonte: Cleostratus, Harpalus)_
- **conjunction**: syzygiae Lunares nonaginta novem in Octaeteride — novilunia et pleniluniа _(data: Octaeteris (ciclo de 8 anos), local: , fonte: Harpalus)_


### Flags de incerteza

- Linha 19: 'horarum 12' — no original aparece '354 horarum 12', mas o valor exato do mês lunar é 29d 12h½; a multiplicação 354d 12h × 8 = 2834 dias confirmada.
- Fração 7/46 lida no scan; denominador pequeno, possivelmente '46' como indicado pelo contexto.


### Notas do tradutor

Página trata da octaetéride de Harpalo em contraste com a de Cleóstrato. O cálculo-chave: 99 sizígias × 30 dias = 2970; 2970 - 2924 = 46 meses cavos; portanto 53 meses plenos. A página termina anunciando uma tabela (ΜΗΝΕΣ) que aparecerá na página seguinte.
