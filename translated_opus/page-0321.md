<!-- PAGE 321 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Tabela marginal: ciclos solares Elkupti e Juliano, Plinthios, Féria de Thoth (28 linhas)
**en:** Marginal table: Elkupti and Julian Solar Cycles, Plinthios, Thoth weekday (28 rows)
...
**pt:** LATERCULUS MENSIUM ACTIACORUM — Lista dos meses ácciacos: nomes dos meses egípcios (em árabe, transliteração latina, e copta/grega) e dos meses etíopes (em etiópico e transliteração), com dois caracteres numéricos (Character mensium / Alter character).
**en:** LATERCULUS MENSIUM ACTIACORUM — List of Actiac months: names of the Egyptian months (in Arabic, Latin transliteration, and Coptic/Greek) and of the Ethiopian months (in Ethiopic and transliteration), with two numerical characters (Character mensium / Alter character).
...
A página discute a fixidez dos meses egípcios desde Augusto (contra a atribuição a Diocleciano), a manutenção dos anos de Diocleciano pelos coptas ('Elkupti Christianis'), e apresenta na parte inferior o 'Laterculus Mensium Actiacorum', tabela quadrilíngue dos meses ácciacos em árabe, copta (transliterado e em grego), e etíope.
