<!-- PAGE 937 | type=text | model=claude-opus-4-7 -->
...
Página de comentário filológico de Scaliger sobre fragmentos relativos a Bel/Belit e à identidade do Dario Medo bíblico (Dn 9). Argumenta que Dario era 'oriundo dos medos' por seu pai (Xerxes/Ahasuerus/Oxyares), mas não era ele próprio Medo nem rei da Média — refutando os cronologistas tradicionais. Última linha 'gratiae' é catchword/início da próxima página.
