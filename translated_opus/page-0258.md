<!-- PAGE 258 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Meses romanos com dias acumulados, horas, dias dos meses primitivos (pré-Numa) e dias dos meses romanos (pós-Numa)
**en:** Roman months with accumulated days, hours, days of the primitive (pre-Numa) months, and days of the Roman (post-Numa) months

| MENSES ROMANI | Dies collecti | Horae | Dies mensium priscorum | Dies mensium Romanorum |
|---|---|---|---|---|
| Martius | 29 | 14 | 29 | 31 |
| Aprilis | 59 | 4 | 30 | 29 |
| Maius | 88 | 18 | 29 | 31 |
...
- **other**: Annus Lunaris verus est dierum 354 cum triente, & paulo plus quam duorum horae trientium _(data: , local: , fonte: )_
- **other**: mensis Lunaris, secundum Democritum & conditorem anni veteris Romani, erit dierum 29, horarum 14 _(data: , local: , fonte: Democritus)_


### Flags de incerteza

- Primeira palavra da página lida como 'Eadem' (abreviada 'A dem' com capitular A); possível que o capitular seja 'Ea-' com 'dem' em continuação.
- A citação do carme saliar 'DVONOS MANOS CERVSES DEIVOS IANOS VENET' é arcaica e de leitura difícil; tradução tentativa.


### Notas do tradutor

A página trata da estrutura do antigo ano romano lunar (pré-Numa) de 355 dias com meses alternadamente cavos (29 dias) e cheios (30 dias), e da reforma de Numa que eliminou os números pares. A tabela apresenta a comparação entre os meses primitivos e os romanos reformados.
