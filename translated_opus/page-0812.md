<!-- PAGE 812 | type=text | model=claude-opus-4-7 -->
...
- The Greek word transcribed as ἐπιοῖς (ἐπιοῦς?) after 'neque' is difficult to read and may be a form of ἐπιών (the appropriate/ensuing time); kept as printed.
- Page number in header reads '517' but user supplied page 812 as PDF page; header number retained as printed.
- The three-line marginal set shows fragmentary word-endings (ΙΟΤC / ΝΙΑC / ΑΛΜΟΤC) with triple-dot marks; transcription preserves the apparent majuscule forms with lunate sigmas.


### Notas do tradutor

Discussion of lectionary cells (cellulae) in the Paschal cycle, apparent scribal/printer errors in Greek Psalm titles (ΜΕΤΑΝΙΑC for ΜΕΤΑΝΟΙΑC), and the uncertain episcopal see of Hippolytus (Arabian metropolitan per Gelasius, Portus per Nicephorus).
