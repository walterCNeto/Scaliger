<!-- PAGE 803 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Tabela marginal: caracteres das solenidades pascais (Linha I). Mostra dia e mês (Adhar/Nisan) em correspondência com um segundo número (provavelmente epacta ou caractere).
**en:** Marginal table: characters of Paschal festivals (Line I). Shows day and month (Adhar/Nisan) paired with a second number (likely epact or character).
...
Página inicial das notas de Scaliger sobre o Computus Syrorum. Scaliger explica que o computus foi enviado em árabe (não em siríaco, como ele preferiria), por um sacerdote etíope. Detalha a estrutura de 4 páginas do computus e a correspondência entre anos alexandrinos/selêucidas/antioquenos e anos cristãos (subtração de 311). A tabela marginal com caracteres pascais acompanha o texto mas está parcialmente oclusa pelo texto principal no scan.
