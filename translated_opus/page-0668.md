<!-- PAGE 668 | type=text | model=claude-opus-4-7 -->
...
- **other**: Aut enim aliquo defectu luminarium, vt anni Cambysae, & Darij _(data: anni Cambysae et Darii, local: , fonte: scriptores Graeci)_
...
Fim da seção sobre a cronologia dos Macabeus; início da célebre seção 'De Hebdomadibus Danielis' (Sobre as Semanas de Daniel). A página termina com 'Memo-' iniciando o nome 'Memnon/Mnemon' (Artaxerxes II Mnêmon), continuado na página seguinte.
