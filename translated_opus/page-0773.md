<!-- PAGE 773 | type=text | model=claude-opus-4-7 -->
...
- **other**: novilunium Paschale in XXVII Magabith, anno decimonono cycli; XIV Luna in decima Miazia _(data: ano 19 do ciclo lunar; 27 de Magabith (mês etíope), local: cômputo pascal etíope, fonte: Calendário etíope)_
- **other**: Novilunium indicatum tuba apud priscos Hebraeos (Psalmus LXXXI) _(data: tradição hebraica antiga, local: , fonte: Salmo 81)_


### Flags de incerteza

- Transcrição do texto etíope (ge'ez) aproximada; caracteres difíceis de ler com precisão no scan
- Transcrição árabe 'مقتضى' aproximada; a palavra árabe glosada como 'residuum' pode ser outra raiz
- Marginalia 'ypp̄' (possível abreviação tipográfica ou marca de referência) preservada como aparece


### Notas do tradutor

Página de comentários cronológicos sobre o calendário etíope e a determinação da Páscoa. Scaliger discute a palavra ge'ez 'Matque' (resíduo/epacta) e os meses etíopes Mascaram, Tikmith, Magabith, Miazia. A reclamação 'scribebat Aethiops' refere-se a um colofão manuscrito em um Saltério etíope de 1539 d.C.
