<!-- PAGE 924 | type=text | model=claude-opus-4-7 -->
...
Página com três citações gregas de fontes antigas sobre o dilúvio (Abideno), a Torre de Babel (Abideno), o reinado de Necau (Heródoto II) e os reis de Tiro (Menandro de Éfeso, fonte importante para a cronologia fenícia em Scaliger). A assinatura 'a 4' no rodapé sugere que esta página pertence aos preliminares de uma seção (provavelmente os Excerpta Graeca anexos). A menção a 'Δεσίου πέμπτῃ ἐπὶ δέκα' é cronologicamente relevante mas não é evento astronômico observacional.
