<!-- PAGE 732 | type=mixed | model=claude-opus-4-7 -->
...
- **conjunction**: propter dubium coniunctionis luminarium — menção à incerteza sobre a conjunção dos luminares (Sol e Lua) como motivo para celebrar festas em dois dias _(data: após a instituição do cômputo judaico atual (pós-exílio), local: , fonte: )_
...
Página das páginas finais do livro VII (cabeçalho 'DE EMENDATIONE TEMPORUM LIB. VII. 649' — numeração interna 649, que corresponde à página 732 do PDF). Scaliger cataloga festas judaicas em três categorias (políticas da Lei; por evento antes de Esdras; tempos de Esdras e depois) e então analisa cronologicamente a Xiloforia com base em Josefo, Guerras II, datando-a ao 11º ano de Nero (ciclo solar XVIII, letra dominical F).
