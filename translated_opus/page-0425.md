<!-- PAGE 425 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Tábua da equação das epactas
**en:** Table of the equation of epacts
...
- **other**: nouilunium Paschale erat in 19 Martij, in typo Niceno _(data: saeculo Christi (primeiro século cristão, sob o padrão niceno), local: , fonte: )_
...
Página mista: texto explicativo em torno da Tabula Aequationis Epactarum. A tabela lista anos de Cristo (1, 133, 265... 3241, em incrementos de 132 anos), letra dominical, ano do período, ciclos de intervalo, caracteres de novilúnios pascais, data do novilúnio pascal, epacta e dias isentos. O texto grego κατὰ προέμπτωσιν e κατὰ μετέμπτωσιν preservado em Unicode.
