<!-- PAGE 236 | type=mixed | model=claude-opus-4-7 -->
...
**pt:** Hecaidecaetéride Pascal do bispo Hipólito, a partir do primeiro ano do imperador Alexandre (Severo). Colunas: indicação de ano embolísmico/bissexto, data pascal no calendário romano, sete colunas de letras dominicais (cabeçalho Z, ϛ, E, Δ, Γ, B, A), número do ano do ciclo.
**en:** Paschal Hekkaidekaeteris of Bishop Hippolytus, from the first year of Emperor Alexander (Severus). Columns: marking of embolismic/bissextile years, paschal date in Roman calendar, seven columns of dominical letters (headers Z, ϛ, E, Δ, Γ, B, A), cycle year number.
...
Página mista: breve continuação do texto discursivo sobre o ciclo de 16 anos (hecaidecaetéride) de Hipólito, seguida da Tábua Pascal de Hipólito começando no primeiro ano do imperador Alexandre Severo (222 d.C.). As letras Z, ϛ (stigma=6), E, Δ, Γ, B, A são as letras dominicais gregas que encabeçam as sete colunas; na margem direita reaparecem em ordem inversa (detalhe que Scaliger destaca). Marcadores B, C, D na margem esquerda são marcas de seção do próprio Scaliger.
