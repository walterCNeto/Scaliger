<!-- PAGE 426 | type=text | model=claude-opus-4-7 -->
...
- **other**: nouilunium Paschale, character 1.11.922, in anno Christi 1561 _(data: anno Christi 1561, anno 42 periodi Paschalis Iulianae, local: , fonte: )_
- **other**: nouilunium in VI Aprilis, character 2.12.156, feria secunda, anno Christi 1598 _(data: anno Christi 1598, 6 Aprilis, local: , fonte: )_


### Notas do tradutor

Capítulo técnico sobre o cálculo das epactas e novilúnios pascais. As letras marginais A, B, C, D indicam divisões do texto para referência. 'Rursus' aparece duas vezes como advérbio ('novamente'), não como nome próprio.
